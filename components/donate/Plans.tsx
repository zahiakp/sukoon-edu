...
function Plans() {
  ...
  const ITEMS = [
    { icon: "",count:sqFeet,min:1,max:9,addvalue:1,setCount:setSqFeet,setCountAmd:setSqFeetAmd,amd:1500, size: `${sqFeet} Sq feet`,amount:sqFeetAmd,label:`${sqFeet}%20Sq%20feet`, plan: sqFeetAmd ,link:""},
    { icon: "",count:tenSqFeet,min:10,max:90,addvalue:10,setCount:setTenSqFeet,setCountAmd:setTenSqFeetAmd,amd:1500, size: `${tenSqFeet} Sq feet`,amount:tenSqFeetAmd,label:`${tenSqFeet}%20Sq%20feet`, plan: tenSqFeetAmd ,link:""},
    { icon: "",count:hundredSqFeet,min:100,max:900,addvalue:100,setCount:setHundredSqFeet,setCountAmd:setHundredSqFeetAmd,amd:1500, size: `${hundredSqFeet} Sq feet`,amount:hundredSqFeetAmd,label:`${hundredSqFeet}%20Sq%20feet`, plan: hundredSqFeetAmd,link:"" },
    { icon: "",count:"",min:"",max:"",addvalue:"",setCount:"",setCountAmd:"",amd:"", size: "Classroom",amount:"800000",label:"Classroom", plan: "8,00,000",link:"" },
  ...
  return (
    <div className=" py-8 relative overflow-hidden group bg-lime-50">
      ...
      <div className="mt-10 w-full grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        >
          {" "}
          <p className="text-lg p-3 px-5 flex items-center justify-between">{item.size} <span className="flex gap-1">
            <button onClick={()=>handleDecrement(item.count,item.amd,item.setCount,item.setCountAmd,item.min,item.addvalue)} className="rounded-[8px] border border-zinc-300 p-2 bg-white w-8 h-8 flex items-center justify-center cursor-pointer">-</button>
            <button onClick={()=>{handleIncrement(item.count,item.amd,item.setCount,item.setCountAmd,item.max,item.addvalue)}} className="rounded-[8px] border border-zinc-300 p-2 bg-white w-8 h-8 flex items-center justify-center cursor-pointer">+</button></span></p>
