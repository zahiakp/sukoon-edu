      ...
      <div className="w-full max-w-[1200px] mx-auto p-7 md:p-10 flex flex-col items-center">
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
          {ITEMS.map((item: any, i: number) => (
            <div key={i} className="relative overflow-hidden min-w-full pb-9 px-5 md:px-10 py-5 pt-2 bg-gradient-to-br from-lime-200 to-lime-300 hover:shadow-lg hover:-translate-y-1 duration-300 group/box rounded-2xl">
              <p className="Grotesque-font  overflow-hidden group-hover/box:scale-110 duration-300 text-5xl md:text-7xl font-semibold text-lime-800">{item.count}</p>
              <p>{item.dis}</p>
