    ...
    onSubmit: async (values) => {
      try {
        setLoading(true);
          ...
          const newsUploadResult = await uploadcareer(
            values.title,
            values.body,
            values.type,
          );
          if (newsUploadResult) {
            showMessage("Careers uploaded successfully","success")
          ...
          <div className="grid gap-2 w-full text-lg">
            ...
            >
              {loading ? (
                ...
                <>
                  <IoMdAddCircleOutline  className="text-lg ml-2" />
                  <p>Add</p>
                </>
              )}
            </button>
