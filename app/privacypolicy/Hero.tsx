...
function Hero() {
  return (
    ...
    style={{backgroundImage:'linear-gradient(to top, rgba(0, 0, 0,0.9), rgba(0,0,0,0)),url(https://www.4sdevelopers.com/img/64c8bcf299b831b40d0d8bcb_privacy-banner.jpeg)',
        backgroundPosition:"center",
        backgroundSize:"cover",
    }}>
      <div className='p-20 px-[15%] flex flex-col h-full items-start justify-end text-white'>
        <h1 className='text-5xl md:text-7xl font-bold font Grotesque-font text-sky-200'>Privacy & Policy</h1>
