...
function Hero() {
  return (
    ...
    style={{backgroundImage:'linear-gradient(to top, rgba(0, 0, 0,0.7), rgba(0,0,0,0)),url(/image/2.jpg)',
        backgroundPosition:"center",
        backgroundSize:"cover",
    }}>
      <div className='p-20 px-[15%] flex flex-col h-full items-start justify-end text-white'>
        <h1 className='text-5xl md:text-7xl font-bold font Grotesque-font text-white'>Connect Us</h1>
