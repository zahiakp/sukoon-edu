...
function Modal({visible,setVisible,paymentData}:{visible: any, setVisible: any,paymentData:any}) {
  ...
  return (
    <Dialog header="Transaction Details" draggable={false} visible={visible} className='p-5 w-[90%] md:w-1/2 rounded-3xl bg-white' onHide={() => {if (!visible) return; setVisible(false); }}>
