...
function ITLabsPlans() {
  ...
  const [tenSqFeetAmd,setTenSqFeetAmd] =useState<any>(40000)
  const [ten1SqFeet,set1TenSqFeet] =useState<any>(10)
  const [ten1SqFeetAmd,set1TenSqFeetAmd] =useState<any>(400000)
    const [fiftySqFeet,setFiftySqFeet] =useState<any>(10)
    const [fiftySqFeetAmd,setFiftySqFeetAmd] =useState<any>(400000)
  const ITEMS = [
    { icon: "",id:"1",count:tenSqFeet,min:1,max:99,addvalue:1,setCount:setTenSqFeet,setCountAmd:setTenSqFeetAmd,amd:40000, size: `${tenSqFeet} computer`,amount:tenSqFeetAmd,label:`${tenSqFeet}%20Sq%20feet`, plan: tenSqFeetAmd ,link:""},
    // { icon: "",id:"2",count:ten1SqFeet,min:10,max:990,addvalue:10,set1Count:set1TenSqFeet,set1CountAmd:set1TenSqFeetAmd,amd:40000, size: `${ten1SqFeet} computer`,amount:ten1SqFeetAmd,label:`${ten1SqFeet}%20Sq%20feet`, plan: ten1SqFeetAmd ,link:""},
    { icon: "",id:"2",count:fiftySqFeet,min:10,max:9990,addvalue:10,setCount:setFiftySqFeet,setCountAmd:setFiftySqFeetAmd,amd:40000, size: `${fiftySqFeet} computer`,amount:fiftySqFeetAmd,label:`${fiftySqFeet}%20Sq%20feet`, plan: fiftySqFeetAmd,link:"" },
  ];
...
// const validCounts = [tenSqFeet]
  ...
  return (
    <div id="itlab" className=" py-8 relative overflow-hidden group bg-white">
      <div className="w-full max-w-[1000px] mx-auto p-7 md:p-10 flex flex-col items-center">
                         <h6 className="text-4xl md:text-5xl text-center Grotesque-font text-neutral-600 font-bold flex gap-4 items-center">
                                                                                        ...
                                                                                        <span className="text-2xl text-neutral-600 p-4 w-fit rounded-2xl bg-neutral-200/70"><FaComputer /></span>
                                                                                          {/* <TextAnimate animation="blurInUp" by="word"> */}
                                                                                          Digital Lab
                                                                                                  {/* </TextAnimate> */}
                                                                                                </h6>
                                                                                <p className="text-zinc-500 text-center text-[16px] my-5">
                                                                                  Your contribution will help us establish state-of-the-art IT labs for underprivileged schools in North India. Together, we can bridge the digital divide and empower children with the tools they need to succeed in the modern world.
                                                                                </p>
