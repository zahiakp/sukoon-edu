...
function ClassPlans() {
  ...
  const [tenSqFeetAmd,setTenSqFeetAmd] =useState<any>(1500000)
  const [fiftySqFeet,setFiftySqFeet] =useState<any>(10)
  const [fiftySqFeetAmd,setFiftySqFeetAmd] =useState<any>(1000)
  const ITEMS = [
    { icon: "",id:"1",count:tenSqFeet,min:1,max:99,addvalue:1,setCount:setTenSqFeet,setCountAmd:setTenSqFeetAmd,amd:1500000, size: `${tenSqFeet} Classroom`,amount:tenSqFeetAmd,label:`${tenSqFeet}%20Sq%20feet`, plan: tenSqFeetAmd ,link:""},
    { icon: "",id:"2",count:fiftySqFeet,min:10,max:9999,addvalue:10,setCount:setFiftySqFeet,setCountAmd:setFiftySqFeetAmd,amd:100, size: `${fiftySqFeet} Library books`,amount:fiftySqFeetAmd,label:`${fiftySqFeet}%20Sq%20feet`, plan: fiftySqFeetAmd,link:"" },
  ];
